...
<template>
    <section class="w-screen h-screen flex flex-col justify-center bg-shark-950 -z-50 ">
        <span class="absolute  w-auto h-auto font-bold text-center border border-white bottom-64 right-32 text-4xl text-white"> VHS </span>
        <span class="absolute bg-blue-500 w-1.5-screen bottom-32 h-8 -left-6 -rotate-12"></span>
        <span class="absolute bg-green-500 w-1.5-screen bottom-24 h-8 -left-6 -rotate-12"></span>
        <span class="absolute bg-yellow-500 w-1.5-screen bottom-16 h-8 -left-6 -rotate-12"></span>
        <span class="absolute bg-red-500 w-1.5-screen bottom-8 h-8 -left-6 -rotate-12"></span>
            <<div
